...
<template>
  ...
  <div v-else-if="backendUrl" id="bodydiv">
    <div id="selectData">
      ...
      >
        <div
          style="margin-left:auto;margin-right:auto;font-size: 28px; color: rgb(110,110,110); margin-bottom:70px; text-align: center;"
        >
      ...
      <div
        style="margin: 25px auto 0px auto; font-size: 23px; width: 600px; text-align:center; color: rgb(110,110,110)"
      >
        <div>
